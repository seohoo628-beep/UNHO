...
import BmLogClient, { type BmLog } from "./BmLogClient";
...
export default async function Page() {
  ...
  if (logRes.error && (logRes.error.code === "42P01" || /bm_logs/.test(logRes.error.message ?? ""))) {
    dbReady = false;
  ...
  return <BmLogClient logs={logs} users={users} today={seoulToday()} dbReady={dbReady} />;
}
