...
import MdLogClient, { type MdLog } from "./MdLogClient";
...
export default async function Page() {
  ...
  if (logRes.error && (logRes.error.code === "42P01" || /md_logs/.test(logRes.error.message ?? ""))) {
    dbReady = false;
  ...
  return <MdLogClient logs={logs} users={users} today={seoulToday()} dbReady={dbReady} />;
}
