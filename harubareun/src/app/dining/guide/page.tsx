        ...
        <Card title="📱 홈 화면에 앱으로 추가(설치)">
          <div style={S.body}>
            ...
            <ul style={S.ul}>
              ...
              <li>추가하면 홈 화면에 <b>F&B</b> / <b>다이닝</b> 아이콘이 생깁니다. 두 플랫폼을 각각 따로 추가하세요.</li>
            </ul>
          </div>
        </Card>
...
const MENU_GUIDE: { icon: string; name: string; desc: string }[] = [
  ...
  { icon: "🔗", name: "채널 바로가기", desc: "네이버·구글 검색광고, 네이버 스마트플레이스(리뷰)·예약, 캐치테이블, 배달의민족·쿠팡이츠 관리자 페이지로 바로 이동합니다. 각 서비스 계정으로 로그인해 사용합니다." },
