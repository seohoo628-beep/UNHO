  ...
  return (
    <div className="login-wrap">
      <div className="card login-card">
        ...
        <img src="/brand-logo.svg" alt="하루바른 · 나아 통합 플랫폼" style={{ display: "block", width: "100%", maxWidth: 360, margin: "0 auto 18px" }} />
        <h1 style={{ fontSize: 20 }}>하루바른·나아 운영 플랫폼</h1>
        ...
        <form onSubmit={onSubmit}>
          <label className="field">
            ...
            <input
              ...
              required
              value={email}
              placeholder="name@harubareun.com"
