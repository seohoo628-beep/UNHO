  ...
  return (
    <>
      ...
      <aside className={`sidebar${open ? " open" : ""}`}>
        ...
        <Nav pendingCount={pendingCount} isOwner={isOwner} isCeo={isCeo} isFinance={isFinance} isGuest={isGuest} counts={counts} folderOrder={folderOrder} folderGroups={folderGroups} />
        <div className="foot">
