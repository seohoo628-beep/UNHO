...
const PLATFORM_LABEL = "운호 F&B 매장관리";
    ...
    <>
      ...
      <div className="stack">
        ...
        <Card title="1. 화면 구성 (딱 3가지만 기억)">
          <div style={S.body}>
            <ol style={S.ol}>
              ...
              <li><b>맨 위 매장 선택</b> — 관리할 <b>매장</b>을 고릅니다. 매장별로 따로 관리하며, 고른 매장 기준으로 모든 화면이 바뀝니다.</li>
        ...
        <Card title="8. 잘 안 될 때">
          <div style={S.body}>
            <ul style={S.ul}>
              <li><b>입력한 게 안 보여요</b> → 맨 위 <b>매장 선택</b>이 그 매장으로 되어 있는지 확인.</li>
